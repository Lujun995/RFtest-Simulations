#H0_d_c: type I error, with dependent Zi, binary outcome
#sample size=50
...
for(h in 1:iter){
  ...
  if(h %% round(iter/100) == 0) save.image(file="/hpc/home/lz197/RFomnibus/H0_d_c_r12.RData")
}
save.image(file="/hpc/home/lz197/RFomnibus/H0_d_c_r12.RData")